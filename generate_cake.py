...
def process_sketch(sketch_base64):
    try:
        ...
        # Tiền xử lý với Canny (vẫn giữ logic Canny)
        ...
        # Gọi Hugging Face API với mô hình thay thế
        headers = {
            "Authorization": f"Bearer {HF_API_TOKEN}",
        }
        payload = {
            "inputs": {
                "image": canny_base64,  # Sử dụng ảnh Canny làm input
        ...
        print("Đang gọi Hugging Face API...")
        ...
        print(f"Lỗi tổng thể trong process_sketch: {str(e)}")
        return str(e)